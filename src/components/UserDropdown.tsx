...
const UserDropdown: React.FC = () => {
    ...
    const user: userType = { name: 'John', email: 'abc@gmail.com' }
    return (
        <DropdownMenu>
            <DropdownMenuTrigger>
                <div className="flex items-center gap-3 text-gray-400 hover:text-yellow-500">
                    <Avatar className='h-8 w-8'>
                        ...
                        <AvatarFallback className='bg-yellow-500 text-yellow-900 text-small font-bold'>{user.name[0]}</AvatarFallback>
                    </Avatar>
